...
class FireOrderDetails {
  ...
  static FireOrderDetails fromJson(Map<String, dynamic> json) => FireOrderDetails(
        ...
        dropPointAddress: json['drop_point_address'] ?? '',
        dropPointImage: json['drop_point_image'] ?? '',
        dropPointName: json['drop_point_name'] ?? '',
        dropPointPhone: json['drop_point_phone'] ?? '',
        note: json['note'] ?? '',
        paymentMethod: json['payment_method'] as String,
        pickUpPointAddress: json['pickup_point_address'] as String,
        pickUpPointImage: json['pickup_point_image'] ?? '',
        pickUpPointName: json['pickup_point_name'] ?? '',
        pickUpPointPhone: json['pickup_point_phone'] ?? '',
