...
class _PrintTestState extends State<PrintTest> {
                  ...
                  children: [
                    GestureDetector(
                      onTap: () async {
                        ...
                        Uint8List byte = await _getImageFromAsset('assets/images/dash.jpg');
  ...
  void initState() {
    super.initState();
    // SystemChrome.setPreferredOrientations([DeviceOrientation.landscapeRight, DeviceOrientation.landscapeRight]);
